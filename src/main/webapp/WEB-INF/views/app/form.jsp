    ...
    <div id="applist-body">
        <div class="app-list-wrap">
            <div class="list-title">
                <h1 style="float: left;"><spring:message code="app.reg.title"/></h1>
            </div>
            <div class="new-app-wrap">
                <form id="appForm" name="app" action="<c:url value='/app/regist'/>" method="post">
                <input type="hidden" name="platform" id="platform" value="1"/>
                <input type="hidden" name="appType" id="appType" value="${param.apptype}"/>
                <div>
                    <img src="<c:url value="/resources/img/btn_ios_active.png"/>" class="btn_platform hand" id="ios" title="ios" alt="ios"/>
                ...
                <div class="new-app-info">
                    <ul>
                        <li>
                            ...
                            <input id="appname" name="appname" class="span8" type="text" maxlength="35"/>
                        </li>
                        <li>
                ...
                <div class="new-app-info">
                    <ul>
                        <li>
                            <p class="info-txt"><spring:message code="app.reg.addInfo.appKey"/></p><p class="info-sub-txt appId">App Store application ID, 9-digit numbber</p>
                            <input id="appid" name="appid" class="span8" type="text" placeholder="App Store application ID(9-digit numbber)" maxlength="100"/>
                        </li>
                        <li>
                            <p class="info-txt"><spring:message code="app.reg.addInfo.marketAcc"/></p>
                            <p class="info-sub-txt marketId">iTunes Connect ID</p>
                            <input id="marketid" name="marketid" class="span8" type="text" placeholder="iTunes Connect ID" maxlength="100"/>
                        </li>
                    </ul>
                </div>
                <div class="new-app-btn">
                    <a href="<c:url value="/app/list"/>" class="btn btn-large bottom-button span2"><spring:message code="btn.cancel.text"/></a>
