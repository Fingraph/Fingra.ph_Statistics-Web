...
public interface TodayService {
	...
	FrequencyData getFrequenceyTimelyRanges(FingraphSearchParam searchParam);
	...
	List<SessionLengthData> getSessionLengthFrequenceyList(FingraphSearchParam searchParam);

	SessionLengthData getSessionLengthFrequencey(FingraphSearchParam searchParam);
