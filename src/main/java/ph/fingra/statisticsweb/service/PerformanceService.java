...
public interface PerformanceService {
	...
	List<TimeSeriesData> getNewUsersWeeklyInfoList(FingraphSearchParam searchParam);
	...
	FrequencyData getFrequenceyDailyRanges(FingraphSearchParam searchParam);

	FrequencyData getFrequenceyWeeklyRanges(FingraphSearchParam searchParam);

	FrequencyData getFrequenceyMonthlyRanges(FingraphSearchParam searchParam);
